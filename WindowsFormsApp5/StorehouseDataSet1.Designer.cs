...
namespace WindowsFormsApp5 {
    ...
    public partial class StorehouseDataSet1 : global::System.Data.DataSet {
        ...
        public partial class productsDataTable : global::System.Data.TypedTableBase<productsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public productsRow AddproductsRow(string name, decimal price, int quantity, System.DateTime expiration_date) {
...
namespace WindowsFormsApp5.StorehouseDataSet1TableAdapters {
    ...
    public partial class productsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[products] SET [name] = @name, [price] = @price, [quantity] = @quantity, [expiration_date] = @expiration_date WHERE (([id] = @Original_id) AND ([name] = @Original_name) AND ([price] = @Original_price) AND ([quantity] = @Original_quantity) AND ([expiration_date] = @Original_expiration_date));
SELECT id, name, price, quantity, expiration_date FROM products WHERE (id = @id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id, name, price, quantity, expiration_date FROM dbo.products";
        ...
        public virtual int Delete(int Original_id, string Original_name, decimal Original_price, int Original_quantity, System.DateTime Original_expiration_date) {
        ...
        public virtual int Update(string name, decimal price, int quantity, System.DateTime expiration_date, int Original_id, string Original_name, decimal Original_price, int Original_quantity, System.DateTime Original_expiration_date, int id) {
            if ((name == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string name, decimal price, int quantity, System.DateTime expiration_date, int Original_id, string Original_name, decimal Original_price, int Original_quantity, System.DateTime Original_expiration_date) {
            return this.Update(name, price, quantity, expiration_date, Original_id, Original_name, Original_price, Original_quantity, Original_expiration_date, Original_id);
        }
    }
