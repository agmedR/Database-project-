...
namespace WindowsFormsApp5 {
    ...
    public partial class WareHouseDataSet1 : global::System.Data.DataSet {
        ...
        public partial class ProductsDataTable : global::System.Data.TypedTableBase<ProductsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public ProductsRow AddProductsRow(string Code, string Name, decimal Price, int Quantity, string Active_substance) {
...
namespace WindowsFormsApp5.WareHouseDataSet1TableAdapters {
    ...
    public partial class ProductsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Products] SET [Code] = @Code, [Name] = @Name, [Price] = @Price, [Quantity] = @Quantity, [Active_substance] = @Active_substance WHERE (([ID] = @Original_ID) AND ([Code] = @Original_Code) AND ([Name] = @Original_Name) AND ([Price] = @Original_Price) AND ([Quantity] = @Original_Quantity) AND ((@IsNull_Active_substance = 1 AND [Active_substance] IS NULL) OR ([Active_substance] = @Original_Active_substance)));
SELECT ID, Code, Name, Price, Quantity, Active_substance FROM Products WHERE (Code = @Code)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::WindowsFormsApp5.Properties.Settings.Default.WareHouseConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, Code, Name, Price, Quantity, Active_substance FROM dbo.Products";
        ...
        public virtual int Delete(int Original_ID, string Original_Code, string Original_Name, decimal Original_Price, int Original_Quantity, string Original_Active_substance) {
        ...
        public virtual int Update(string Code, string Name, decimal Price, int Quantity, string Active_substance, int Original_ID, string Original_Code, string Original_Name, decimal Original_Price, int Original_Quantity, string Original_Active_substance) {
            if ((Code == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, decimal Price, int Quantity, string Active_substance, int Original_ID, string Original_Code, string Original_Name, decimal Original_Price, int Original_Quantity, string Original_Active_substance) {
            return this.Update(Original_Code, Name, Price, Quantity, Active_substance, Original_ID, Original_Code, Original_Name, Original_Price, Original_Quantity, Original_Active_substance);
        }
    }
